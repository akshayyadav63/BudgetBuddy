    ...
    <div className="flex min-h-screen items-center justify-center bg-gradient-to-br from-purple-600 to-blue-500 p-4">
      <div className="w-full max-w-md overflow-hidden rounded-2xl bg-white shadow-xl">
        <div className="bg-purple-600 p-6 text-center">
          ...
          <p className="mt-2 text-purple-100">Join our community today</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="p-8">
          ...
          <button
            type="submit"
            className="w-full rounded-lg bg-purple-600 py-3 text-center font-medium text-white shadow-md transition duration-200 hover:bg-purple-700 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:ring-offset-2"
          >
            Create Account
          </button>
          ...
          <div className="mt-6">
            ...
            <div className="mt-6 grid grid-cols-3 gap-3">
              <button
                type="button"
                className="flex w-full items-center justify-center rounded-lg border border-gray-300 bg-white py-2 px-4 text-gray-500 shadow-sm hover:bg-gray-50"
              >
